...
public class Main {
	...
	private void initialize() {
		...
		JComboBox TeansSQ1 = new JComboBox();
		TeansSQ1.setBounds(209, 138, 241, 22);
		SQP1.add(TeansSQ1);
		...
		SQAddTeam.setBounds(281, 196, 97, 25);
		SQP1.add(SQAddTeam);
		...
		AddPlayerSQ2.setBounds(284, 196, 97, 25);
		...
		comboBox.setBounds(212, 131, 241, 22);
		SQP3.add(comboBox);
		
		btnChooseTeam = new JButton("Choose Team ");
		btnChooseTeam.setBounds(284, 189, 97, 25);
